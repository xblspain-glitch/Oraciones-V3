...
/* ===== V3.1.181 — Contadores inferiores con iconos propios ===== */
(function(){
  if(window.__v3181CountersInstalled) return;
  window.__v3181CountersInstalled = true;

  function countOf(arr){ return Array.isArray(arr) ? arr.length : 0; }

  window.renderHomeCountersV3181 = function(){
    try{
      var c = document.getElementById('counterInfo');
      if(!c || !window.state) return;
      var counts = {
        prayers: countOf(state.prayers),
        notes: countOf(state.notes),
        guides: countOf(state.guides),
        parables: countOf(state.parables),
        psalms: countOf(state.psalms),
        verses: countOf(state.verses)
      };
      c.innerHTML = '' +
        '<span class="counter-inline-v3181" aria-label="Contadores principales">' +
          '<span class="counter-chip-v3181" title="Oraciones"><span class="counter-icon-v3181 counter-icon-cross-v3181" aria-hidden="true"></span><span class="counter-count-v3181">' + counts.prayers + '</span></span>' +
          '<span class="counter-sep-v3181" aria-hidden="true">|</span>' +
          '<span class="counter-chip-v3181" title="Notas"><img class="counter-icon-v3181 counter-icon-img-v3181" src="icon-notas-detallado-v2210.png" alt=""><span class="counter-count-v3181">' + counts.notes + '</span></span>' +
          '<span class="counter-sep-v3181" aria-hidden="true">|</span>' +
          '<span class="counter-chip-v3181" title="Guía"><img class="counter-icon-v3181 counter-icon-img-v3181" src="icon-guia-detallado-v2210.png" alt=""><span class="counter-count-v3181">' + counts.guides + '</span></span>' +
          '<span class="counter-sep-v3181" aria-hidden="true">|</span>' +
          '<span class="counter-chip-v3181" title="Parábolas"><span class="counter-icon-v3181 counter-icon-parables-v3181" aria-hidden="true">🌱</span><span class="counter-count-v3181">' + counts.parables + '</span></span>' +
          '<span class="counter-sep-v3181" aria-hidden="true">|</span>' +
          '<span class="counter-chip-v3181" title="Salmos"><span class="counter-icon-v3181 counter-icon-psalms-v3181" aria-hidden="true">♫</span><span class="counter-count-v3181">' + counts.psalms + '</span></span>' +
          '<span class="counter-sep-v3181" aria-hidden="true">|</span>' +
          '<span class="counter-chip-v3181" title="Versículos"><span class="counter-icon-v3181 counter-icon-heart-v3181" aria-hidden="true">💚</span><span class="counter-count-v3181">' + counts.verses + '</span></span>' +
        '</span>';
    }catch(e){ console.error('renderHomeCountersV3181', e); }
  };

  var oldSyncTabsV3181 = window.syncTabs;
  window.syncTabs = function(){
    if(typeof oldSyncTabsV3181 === 'function') oldSyncTabsV3181.apply(this, arguments);
    window.renderHomeCountersV3181();
  };
  try{ syncTabs = window.syncTabs; }catch(e){}

  if(document.readyState === 'loading'){
    document.addEventListener('DOMContentLoaded', function(){ setTimeout(window.renderHomeCountersV3181, 0); });
  } else {
    setTimeout(window.renderHomeCountersV3181, 0);
  }
})();
