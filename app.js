/* Oraciones V3 LAB - paso 25: limpieza interna segura (sin tocar datos/cache) */
...
function switchSectionAndReadV90187(s){
  try{
    switchSection(s);
    if(s==="prayers" || s==="notes" || s==="guides" || s==="parables"){
      setTimeout(function(){
...
function updateVersePositionCounter(){
  try{
    ...
    if(!["verses","prayers","notes","guides","parables"].includes(section)){
