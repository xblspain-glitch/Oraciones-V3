const CACHE_NAME="oraciones-v3-1-320-tarjetas-milagros-actualizadas";
...
CORE.push(
  "./styles.css?v=3.1.320",
  "./app.js?v=3.1.320",
  "./storage-idb-safe-v31314.js?v=3.1.320",
  "./app-loader.js?v=3.1.313",
  "./app-loader-recovery-v31313.js?v=3.1.313",
  "./app-loader-safe-v31314.js?v=3.1.320",
  "./counters-v3183-v31313.js?v=3.1.320",
  "./storage-idb.js",
  "./storage-idb-safe-v31314.js",
  "./app-loader.js",
  "./app-loader-recovery-v31313.js",
  "./app-loader-safe-v31314.js",
  "./counters-v3183-v31313.js",
  "./card-segunda-venida-3-v31301.png",
  "./card-segunda-venida-3-v31301.png?v=2.290",
  "./card-fe-3-v31301.png",
  "./card-fe-3-v31301.png?v=2.290",
  "./card-cristo-es-dios-3-v31301.png",
  "./card-cristo-es-dios-3-v31301.png?v=2.290",
  "./card-dios-3-v31301.png",
  "./card-dios-3-v31301.png?v=2.290",
  "./card-salvacion-4-v31301.png",
  "./card-salvacion-4-v31301.png?v=2.290",
  "./card-oracion-3-v31301.png",
  "./card-oracion-3-v31301.png?v=2.290",
  "./card-milagros-1-v31319.png",
  "./card-milagros-2-v31319.png",
  "./card-milagros-3-v31319.png"
);
self.addEventListener("install",event=>{event.waitUntil((async()=>{const cache=await caches.open(CACHE_NAME);await cache.addAll(CORE);await self.skipWaiting();})());});
